...
public class Gui {
  ...
  ListProcesses list;
  String [] colorsBordersPartition = { "#e7c500", "#0022e7", "#00e751","#596373","#00e7c5"};
  ...
  /**
   * guarda em um hash a lista e Box de cada estados
   */
  ...
  /**
   * atualiza lista dos estados pronto e finalizado
   */
  public void updateLists(){
    ...
    /**
     * atualiza lista da memoria na interface
     */
