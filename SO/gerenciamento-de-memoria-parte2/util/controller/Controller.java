 ...
 * Nome: ...........: Controller
 * Funcao...........: inicializa objetos da interface grafica
 * ***************************************************************/
...
public class Controller implements Initializable{
    ...
    @FXML
    private CheckMenuItem fast_fit;
    @FXML
    private CheckMenuItem first_fit;
    @FXML
    private CheckMenuItem worst_fit;
    @FXML
    private CheckMenuItem best_fit;
    @FXML
    private MenuButton menuTypesAllocations;
    @FXML
    private Pane PaneMemory;
    @FXML
    private Pane paneFastFit;
    ListProcesses list;
  ...
  public void initialize(URL location, ResourceBundle resources) {
    paneFastFit.setStyle("-fx-background-color:  #e3f7ff");
    paneFastFit.setVisible(true);
    start = false;
    Label [] indexBox  = {lbl_00, lbl_01, lbl_02, lbl_03, lbl_04, lbl_05, lbl_06, lbl_07, lbl_08, lbl_09, lbl_10, lbl_11, lbl_12, lbl_13,
       lbl_14, lbl_15, lbl_16, lbl_17, lbl_18, lbl_19, lbl_20, lbl_21, lbl_22, lbl_23, lbl_24, lbl_25, lbl_26, lbl_27, lbl_28, lbl_29};
    ...
    Label [] borderLBL = {lbl_border00, lbl_border01, lbl_border02, lbl_border03, lbl_border04, lbl_border05, lbl_border06, lbl_border07, lbl_border08, lbl_border09,
       lbl_border10, lbl_border11, lbl_border12, lbl_border13, lbl_border14, lbl_border15, lbl_border16, lbl_border17, lbl_border18, lbl_border19, 
       lbl_border20, lbl_border21, lbl_border22, lbl_border23, lbl_border24, lbl_border25, lbl_border26, lbl_border27, lbl_border28, lbl_border29};
    
    items = new CheckMenuItem [] {first_fit, best_fit, worst_fit, fast_fit};
    
    list = new ListProcesses();
    memory = new ManagementMemory();
    memory.setFastFitPartitions(instacePartitionsAbsolute());
  ...
  /**
   * pinta a divisao das particoesw
   * @param i
   * @param gui
   */
  public void paint(int i, Gui gui){
    ...
    switch(i){
      case 0:
        PaneMemory.setStyle("-fx-border-color: #24bcbc; -fx-border-width: 5;");
        gui.paintPartitions("e3f7ff",new Pointer(indexStart, indexEnd));
        paneFastFit.setVisible(true);

        break;
      case 1:
        gui.paintPartitions("e3f7ff",new Pointer(indexStart, indexEnd));
        PaneMemory.setStyle("-fx-border-color: #74bb24; -fx-border-width: 5;");
        paneFastFit.setVisible(true);
        
        break;
      case 2:
        gui.paintPartitions("e3f7ff",new Pointer(indexStart, indexEnd));
        PaneMemory.setStyle("-fx-border-color: #be252a; -fx-border-width: 5;");
        paneFastFit.setVisible(true);

        break;
      case 3:

        PaneMemory.setStyle("-fx-border-color:  #9206FF; -fx-border-width: 5;");
        gui.paintPartitions(
          memory.getFastFitPartitions().get(0),
          memory.getFastFitPartitions().get(1),
          memory.getFastFitPartitions().get(2),
          memory.getFastFitPartitions().get(3));
          paneFastFit.setVisible(false);
      default:
        break;
    }
  }
  ...
  /**
   * instacePartitionsAbsolute
   * seta as particoes para o tipo de escalonamento usado
   * @return
   */
  private List<Pointer> instacePartitionsAbsolute(){
    return Arrays.asList(
    new Pointer(new IndexMemory(0, false), new IndexMemory(5, false)),
    new Pointer(new IndexMemory(5, false), new IndexMemory(13, false)),
    new Pointer(new IndexMemory(12, false), new IndexMemory(25, false)),
    new Pointer(new IndexMemory(25, false), new IndexMemory(30, false)));
  }
}
